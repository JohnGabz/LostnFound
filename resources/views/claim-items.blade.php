                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card h-100 shadow-sm">
                                ...
                                <div class="card-header bg-light d-flex align-items-center">
                                    <div class="rounded-circle bg-warning text-white d-flex align-items-center justify-content-center mr-2" style="width: 35px; height: 35px;">
                                ...
                                @if($claim->item->image_path)
                                    <img src="{{ asset('storage/' . $claim->item->image_path) }}" class="card-img-top" alt="{{ $claim->item->title }}" style="height: 180px; object-fit: cover;">
                                @else
                                ...
                                <div class="card-footer text-center bg-white border-top-0">
                                    <a href="{{ route('items.show', $claim->item->id) }}" class="btn btn-outline-primary btn-sm btn-block">View Item</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="row">
                    @foreach($approvedClaims as $claim)
                        <div class="col-md-3 mb-4">
                            <div class="card h-100 shadow-sm">
                                <div class="card-header bg-light d-flex align-items-center">
                                    <div class="rounded-circle bg-success text-white d-flex align-items-center justify-content-center mr-2" style="width: 35px; height: 35px;">
                                        {{ strtoupper(substr($claim->item->user->name ?? 'A', 0, 1)) }}
                                    </div>
                                    <div>
                                        <div class="font-weight-bold small">{{ $claim->item->user->name ?? 'Unknown' }}</div>
                                ...
                                <div class="card-body">
                                    <h5 class="card-title mb-2">{{ $claim->item->title }}</h5>
                                    <p class="mb-1"><strong>Status:</strong> <span class="badge badge-success">Approved</span></p>
                ...
                <div class="row">
                    @foreach($rejectedClaims as $claim)
                        <div class="col-md-3 mb-4">
                            <div class="card h-100 shadow-sm">
                                <div class="card-header bg-light d-flex align-items-center">
                                    <div class="rounded-circle bg-danger text-white d-flex align-items-center justify-content-center mr-2" style="width: 35px; height: 35px;">
                                        {{ strtoupper(substr($claim->item->user->name ?? 'A', 0, 1)) }}
                                    </div>
                                    <div>
                                        <div class="font-weight-bold small">{{ $claim->item->user->name ?? 'Unknown' }}</div>
                                ...
                                <div class="card-body">
                                    <h5 class="card-title mb-2">{{ $claim->item->title }}</h5>
                                    <p class="mb-1"><strong>Status:</strong> <span class="badge badge-danger">Rejected</span></p>
