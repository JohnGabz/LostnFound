...
@section('content')
    <div class="container-fluid px-4 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('items.report', ['type' => 'lost']) }}" class="btn btn-primary shadow-sm">
        ...
        <div class="mb-4">
            <form action="{{ route('lost.index') }}" method="GET" class="form-inline">
                <div class="input-group w-100">
                    ...
                    <input type="text" name="search" class="form-control border-left-0" placeholder="Search Item..."
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-header bg-light d-flex align-items-center">
                                ...
                                <div>
                                    <div class="font-weight-bold small">{{ optional($item->user)->name ?? 'Anonymous' }}</div>
                            ...
                            <div class="card-footer text-center bg-white border-top-0">
                                <a href="{{ route('items.show', parameters: $item) }}"
