...
<body class="min-h-screen flex items-center justify-center bg-white">
  <div class="flex w-full h-screen">
    ...
    <div class="w-1/2 bg-gradient-to-b from-indigo-600 via-indigo-400 to-indigo-100 flex items-center justify-center text-white flex-col">
      ...
      <p class="text-indigo-100 mt-2 text-center">Join our secure platform</p>
    </div>
    ...
    <div class="w-1/2 flex items-center justify-center p-10">
      <div class="w-full max-w-md space-y-6">
        <div>
          ...
          <p class="text-gray-500">Please fill in your information below</p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4" id="registerForm" novalidate>
          ...
          <!-- Name -->
          <div>
            <label for="name" class="block text-gray-700 text-sm mb-1 font-medium">
            ...
            <div class="relative">
              <input 
                ...
                class="w-full pl-10 pr-4 py-3 rounded-lg bg-gray-100 text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 @error('name') field-invalid @enderror" 
              />
              ...
              <div id="nameCheckmark" class="absolute right-3 top-3.5 text-green-500 hidden">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @else
            <p class="mt-1 text-xs text-gray-500" id="name-help">Use your real name (2-100 characters)</p>
            @enderror
          </div>
          ...
          <div>
            ...
            <div class="relative">
              <input 
                ...
                class="w-full pl-10 pr-4 py-3 rounded-lg bg-gray-100 text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 @error('email') field-invalid @enderror" 
              />
              <div class="absolute left-3 top-3.5 text-gray-400">
              ...
              <div id="emailCheckmark" class="absolute right-3 top-3.5 text-green-500 hidden">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
              </div>
            ...
            @else
            <p class="mt-1 text-xs text-gray-500" id="email-help">We'll send a verification link to this email</p>
            @enderror
          </div>
          ...
          <div>
            ...
            <div class="relative">
              <input 
                ...
                class="w-full pl-10 pr-12 py-3 rounded-lg bg-gray-100 text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 @error('password') field-invalid @enderror" 
              />
              <div class="absolute left-3 top-3.5 text-gray-400">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <svg class="w-5 h-5" id="passwordEyeIcon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <!-- Confirm Password -->
          <div>
            <label for="password_confirmation" class="block text-gray-700 text-sm mb-1 font-medium">
            ...
            <div class="relative">
              <input 
                ...
                class="w-full pl-10 pr-12 py-3 rounded-lg bg-gray-100 text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 @error('password_confirmation') field-invalid @enderror" 
              />
              <div class="absolute left-3 top-3.5 text-gray-400">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              ...
              >
                <svg class="w-5 h-5" id="confirmEyeIcon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                </svg>
              </button>
              <div id="confirmCheckmark" class="absolute right-10 top-3.5 text-green-500 hidden">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
              </div>
            ...
            <p class="mt-1 text-sm text-red-600" id="password-confirmation-error">{{ $message }}</p>
            @else
            <p class="mt-1 text-xs text-gray-500" id="confirm-help">Re-enter your password to confirm</p>
            @enderror
          </div>
          ...
          <div>
            <button 
              type="submit" 
              id="registerButton"
              class="w-full py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center"
            >
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function validateForm() {
        ...
        return isNameValid && isEmailValid && isPasswordValid && isConfirmValid && isTermsAccepted;
      }
